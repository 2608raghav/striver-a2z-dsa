...
2. The inner loop will iterate from 0 to N-1 and will print either a space or a number based on the condition j <= i for the first half and (k + i) >= n - 1 for the second half.
