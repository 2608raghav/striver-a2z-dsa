...
4. If the element at the middle index is greater than or equal to the target, update the index of the lower bound and search in the left half.
5. If the element at the middle index is greater than the target, search in the left half.
6. If the element at the middle index is less than the target, search in the right half.
