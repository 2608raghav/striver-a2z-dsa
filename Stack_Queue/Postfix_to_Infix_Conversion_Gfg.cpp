...
Approach:
1. We can use a stack to hold operands and an output string to build the infix expression.
...
3. After processing all characters, the final expression on the stack will be the infix expression.
